...
export const APP_MENU_ITEM = {
  ...
  DASHBOARD_POPUP : [
    ...
    { title: 'Doctors', path: '/doctors', icon: doctors, access:['AD', 'SA', 'MR', "CL", "DP"] },
    ...
    { title: 'Notification', path: '/notification', icon: notification, access:['PT','SA',"AD","MR","HL", "CL", "DP"] },
    { title: 'Support', path: '/support', icon: doctors, access:['PT','SA',"AD","MR","HL", "CL", "DP"] },
  ]
}
