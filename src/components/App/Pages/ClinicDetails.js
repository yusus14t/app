    ...
    return (
        <Container className={'mt-35vh bg-white curved-top'}>
            <div className='clinic-image' >
               <img src={clinicDetail?.photo ? getFullPath(clinicDetail?.photo): background } width={'100%'} height={'100%'}/>
            </div>
            ...
            <section className='clinic-info-card'>
                ...
                <div className='bg-light p-3 curved'>
                    ...
                    <h6>Consultation Fee: <span className='text-primary'>$200</span></h6>
                    <h6>Services</h6>
                    <div class="d-flex flex-wrap">
                        <div class="service-tube m-1 bg-white">Waiting</div>
                        <div class="service-tube m-1 bg-white">Waiting</div>
                        <div class="service-tube m-1 bg-white">Waiting</div>
                        <div class="service-tube m-1 bg-white">Waiting</div>
                        <div class="service-tube m-1 bg-white">Waiting</div>
            ...
            <section className='waiting-section  mt-3 p-3'>
                ...
                <div className='overflow-auto' style={{ height: '60vh'}}>  
                    { Array(20).fill(0).map( a => <div className='bg-light d-flex align-items-center m-2 curved'>
                        <div className='p-3 m-2 bg-white curved'>
                            <h4 className='mb-0'>112</h4>
                        </div> 
                        <div className='ms-2'>
                            <h6>Abdul Bari</h6>
                            <p className='mb-0'>+91 xxx-xxx-2332</p>
                        </div>
                    </div>)}
                </div>
            </section>
            ...
            <section className=' bg-light curved p-2 m-2'>
                <div className='d-flex my-2 bg-white p-2 curved'>
                    <FontAwesomeIcon className='me-3' icon={faLocationDot} />
                    <div>
                        <p className='mb-0'>Our Address</p>
                        <p className='mb-0'>Hamdard Nagar b Jamalpur Aligarh</p>
                    </div>
                </div>
                <div className='d-flex my-2 bg-white p-2 curved'>
                    ...
                    <div>
                        ...
                        <p className='mb-0'>+91 827-323-7781</p>
                    </div>
                </div>
                <div className='d-flex my-2 bg-white p-2 curved'>
                    ...
                    <div>
                        ...
                        <p className='mb-0'>Realhamsob@gmail.com</p>
                    </div>
                </div>
            </section>
        </Container>
